 ...
 *
 * @param config - Config.
 * @param events - A nodejs EventEmitter object.
 */
declare function Editly(
  config: Editly.Config,
...
declare namespace Editly {
  ...
  type CustomCanvasFunction = (
    args: CustomCanvasFunctionArgs
  ) => OptionalPromise<CustomFunctionCallbacks>;
